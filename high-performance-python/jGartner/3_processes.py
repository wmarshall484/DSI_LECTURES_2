...
Try comparing the timings of all these options:
    %timeit %run 3_serial.py 1307674368000 4
    %timeit %run 3_threads.py 1307674368000 4
    %timeit %run 3_processes.py 1307674368000 4
'''
...
if __name__ == '__main__':
    ...
    tests_per_process = int(num_to_test / num_processes)
